...
export default function About() {
  return (
    <>
      <section
        id="About"
        className="flex flex-col sm:flex-row min-h-screen max-w-screen-lg mx-auto px-5 py-10"
      >
        <ScrollReveal style={{}}>
          ...
          <div className="flex flex-col sm:flex-row gap-12">
            ...
            <div className="w-full flex flex-col self-center sm:self-start place-items-center left-0 right-0 top-0 bottom-0 max-w-fit">
              <BackgroundGradient className="relative h-auto w-full hover:-translate-y-3 hover:-translate-x-2  grayscale-[50%] hover:grayscale-[10%] transition-all duration-300">
                <Image
